...
const Navbar = () => {
  ...
  const { cart } = useContext(CartContext); // Cart context: Manage cart states
  const { token, logout, userData } = useContext(AppContext); // App context: Manage user data and auth

  const [showMenu, setShowMenu] = useState(false); // For toggling mobile menu dropdown
