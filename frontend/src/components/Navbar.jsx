...
const Navbar = () => {
    ...
    const { cart } = useContext(CartContext); // Cart context: Handle cart states
    const { token, logout, userData } = useContext(AppContext); // App context: Handle user data and auth
    ...
    return (
        <nav className="flex items-center justify-between py-4 px-6">
            ...
            <ul className="hidden md:flex gap-6 items-center text-sm font-medium">
                ...
                <NavLink to="/doctors" className="hover:text-primary">{t('all_doctors')}</NavLink>
                ...
                <NavLink to="/cart" className="relative flex items-center hover:text-primary">
                    {/* Replace text with the cart icon */}
