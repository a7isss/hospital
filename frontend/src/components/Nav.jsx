...
const Nav = () => {
  const navItems = [
    ...
    { id: 2, name: 'Partners', path: '/Partners', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
    ...
    { id: 4, name: 'Services', path: '/services', icon: 'M4 5h16a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V6a1 1 0 011-1zm3 8v-2h2v2H7zm4 0v-2h2v2h-2zm4 0v-2h2v2h-2z' },
      { id: 5, name: 'Subscriptions', path: '/subscriptions', icon: 'M9 12h6m-6 4h6m-7 4h8c1.333 0 2-.667 2-2v-8c0-1.333-.667-2-2-2H9c-1.333 0-2 .667-2 2v8c0 1.333.667 2 2 2zM15 4l.867-2.6A1 1 0 0015 0H9a1 1 0 00-.867.6L8 4' },
